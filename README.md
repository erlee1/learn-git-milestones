...
- [x] Use the CLI to navigate directories  
  ...
  - [x] Open this README file in Atom and paste that path here: **C:\Users\cello\Sites\critical-web-design\learn-git-milestones\README.md**
...
- [x] Set up a [Github page](https://pages.github.com/) "project site" for your repo
  ...
  - [x] ✏️ Paste this link here: https://erlee1.github.io/my-awesome-project/
